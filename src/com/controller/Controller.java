...
import com.model.parser.SAXReader;
import com.model.parser.WriterXML;
...
public class Controller {
    ...
    public Graph open(File file, Canvas canvas, BaseOfVertex base){
        if (saxReader == null) saxReader = new SAXReader();
        try {
            saxReader.setCanvas(canvas, base);
